...
$(function(){	
	...
	function HtmlSlidePlayer(config){
		...
		var cw = $(window).width();
		var ch = 0;
		ch = Math.floor(cy/cx*cw);
		
		this.factory = function(){
			//元素定位
			$("#mtsBanner").css({position:"relative",zIndex:"0",overflow:"hidden",height:ch});
			$("#mtsBanner").prepend("<div class='slide_control'></div>");

			$("#mtsBanner" + " ul").css({position:"relative",zIndex:"0",margin:"0",padding:"0",overflow:"hidden", width:"100%", height:"100%"})
...
$(document).ready(function(){
    ...
    dropdownOpen();//调用
    $(".index-building img").hover(function(){
